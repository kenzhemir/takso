defmodule TaksoWeb.BookingControllerTest do
  ...
  test "booking requires a 'pickup address'" do
    changeset = Booking.changeset(%Booking{}, %{pickup_address: nil, dropoff_address: "Raatuse 22, 51009 Tartu"})
    assert Keyword.has_key? changeset.errors, :pickup_address
  end

  test "booking requires different pickup and dropoff addresses" do
    changeset = Booking.changeset(%Booking{}, %{pickup_address: "Raatuse 22, 51009 Tartu", dropoff_address: "Raatuse 22, 51009 Tartu"})
